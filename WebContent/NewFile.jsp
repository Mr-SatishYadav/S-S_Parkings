...
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Parking Reservation <small>Available lots</small></h2>
						<h6 style="float:right;"><i class="fa fa-tint"></i>:Washing <i class="fa fa-flash"></i>:Fast Lane <i class="fa fa-cog"></i>:Service <i class="fa fa-magic"></i>:Extra Services</h6>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
					${rslt}
